...
public class Person {
	...
	@Override
	public int hashCode() {
		System.out.println("hashCode메소드 호출됨");
	...
	/*
	오버라이딩 한 두개의 메소드는 항상 동일한 멤버변수간의 비교를 해야한다.
	hashCode()에서는 나이를 반환하고, equals()에서는 이름만 비교하는 형태라면
	이상한 결과가 나올수도 있다.
	 */
	@Override
	public boolean equals(Object obj) {
		...
		if ( person.age == this.age 
			&& person.name.equals(this.name)) { // 이름, 나이 둘 다 비교
